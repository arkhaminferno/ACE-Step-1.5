"""Generate 'Nar' — approved Hawa recipe, two takes."""
...
OUT_DIR = Path("/Users/infy/Downloads/ACE-Step-1.5/batch_deephouse/output/nar")
SLUG = "nar"
HOOK = "نار نار"
SEEDS = [86701, 97812]
...
for seed in SEEDS:
    ...
    out_path = OUT_DIR / f"nar_{tag}.mp3"
    ...
    print(f"GENERATE nar seed={seed} thinking=True")
...
info = {
    ...
    "seeds": results,
    "notes": "Two takes — listen A and B; promote the better one to nar.mp3.",
}
(OUT_DIR / "nar.json").write_text(
